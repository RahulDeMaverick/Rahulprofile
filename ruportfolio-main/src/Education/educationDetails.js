        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-white mt-20 font-poppins">
          <Fade bottom cascade>
            <div className="grid grid-cols-2 gap-6 mt-10">
              ...
              >
                <h2 className="text-3xl font-bold">BE in Computer Science and Engineering</h2>
                <h2 className="text-xl">Anna University, India</h2>
                <p className="mt-10 opacity-50">
               <b> Activities and societies:</b> Organizer of National Level Tech symposium PRAYUDH-2017, Member of Computer Society of India, Member of Rotary Club.Activities and societies: Organizer of National Level Tech symposium PRAYUDH-2017, Member of Computer Society of India, Member of Rotary Club.
                </p>
                <p className="mt-10 opacity-50">
